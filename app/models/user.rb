...
class User < ApplicationRecord
  ...
  def self.ransackable_attributes(_auth_object = nil)
    %w[access_count_to_reset_password_page created_at crypted_password email id name
       reset_password_email_sent_at reset_password_token reset_password_token_expires_at role salt updated_at]
  end
end
